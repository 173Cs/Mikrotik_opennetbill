...
<head>
    <title>ExpressNet Installer</title>
...
<body style='background-color: #FBFBFB;'>
    <div id='main-container'>
        <img src="img/mylogo.png" class="img-responsive" alt="Logo" />
        <hr>
        ...
        <div class="span12">
            ...
            ?>
                <p> MySQL Connection was successfull. An error occured while adding data on MySQL. Unsuccessfull
                    Installation. Please refer manual installation in the website github.com/ibnux/ExpressNet/wiki or Contact Telegram @ibnux  for
    ...
    <div class="footer">Copyright &copy; 2021 ExpressNet. All Rights Reserved<br /><br /></div>
</body>
