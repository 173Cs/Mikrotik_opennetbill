...
<body class="sidebar-mini {if $_kolaps}sidebar-collapse{/if}" >
    <div class="wrapper">
        <header class="main-header">
            <a href="{$_url}dashboard" class="logo">
                <span class="logo-mini"><b>N</b>uX</span>
               <span class="camp-logo"> {$_c['CompanyName']}</span>
            </a>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    <li {if $_system_menu eq 'dashboard' }class="active" {/if}>
                        <a href="{$_url}dashboard">
                            ...
                            <span class="menu1-item">{Lang::T('Dashboard')}</span>
                        </a>
                    </li>
                    ...
                    {if !in_array($_admin['user_type'],['Report'])}
                        <li class="{if in_array($_system_menu, ['customers', 'map'])}active{/if} treeview">
                            <a href="#">
                                <i class="fa fa-users"></i> <span class="menu1-item">{Lang::T('Customer')}</span>
                            ...
                            <ul class="treeview-menu">
                                <li {if $_system_menu eq 'customers' }class="active" {/if}><a
                                        href="{$_url}customers">{Lang::T('All customers')}</a></li>
                                {$_MENU_CUSTOMERS}
                            </ul>
                        </li>
                        ...
                        <li class="{if $_system_menu eq 'plan'}active{/if} treeview">
                            <a href="#">
                                <i class="fa fa-ticket"></i> <span class="menu1-item">{Lang::T('Services')}</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                    ...
                    {if in_array($_admin['user_type'],['SuperAdmin','Admin'])}
                        <li class="{if $_system_menu eq 'services'}active{/if} treeview">
                            <a href="#">
                                <i class="ion ion-cube"></i> <span class="menu1-item">{Lang::T('Plans')}</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                    ...
                    <li class="{if $_system_menu eq 'reports'}active{/if} treeview">
                        <a href="#">
                            <i class="ion ion-clipboard"></i> <span class="menu1-item">{Lang::T('Reports')}</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li {if $_routes[1] eq 'daily-hotspot-report' }class="active" {/if}><a
                                    href="{$_url}reports/daily-hotspot-report">{Lang::T('Daily Hotspot Reports')}</a></li>
                            <li {if $_routes[1] eq 'daily-pppoe-report' }class="active" {/if}><a
                                    href="{$_url}reports/daily-pppoe-report">{Lang::T('Daily PPPOE Reports')}</a></li> 
                            <li {if $_routes[1] eq 'by-period' }class="active" {/if}><a
                                    href="{$_url}reports/by-period-Hotspot">{Lang::T('Period Hotspot Reports')}</a></li>
                            <li {if $_routes[1] eq 'by-period' }class="active" {/if}><a
                                    href="{$_url}reports/by-period-PPPOE">{Lang::T('Period PPPOE Reports')}</a></li>        
                    ...
                    <li class="{if $_system_menu eq 'message'}active{/if} treeview">
                        <a href="#">
                            <i class="ion ion-android-chat"></i> <span class="menu1-item">{Lang::T('Send Message')}</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                    ...
                    {if in_array($_admin['user_type'],['SuperAdmin','Admin'])}
                        <li class="{if $_system_menu eq 'network'}active{/if} treeview">
                            <a href="#">
                                <i class=" icon ion ion-network"></i> <span class="menu1-item">{Lang::T('Network')}</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                    ...
                    <li
                        ...
                        <a href="#">
                            <i class=" icon ion ion-gear-a"></i> <span class="menu1-item">{Lang::T('Settings')}</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                    ...
                    <li {if $_system_menu eq 'support' }class="active" {/if}>
                        <a href="{$_url}support">
                            <i class="icon ion ion-chatboxes"></i>
                            <span class="text menu1-item">Support</span>
                        </a>
                    </li>
                    {$_MENU_AFTER_SUPPORT}
                </ul>
