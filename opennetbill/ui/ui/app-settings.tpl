                ...
                <div class="panel-body">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="apiKey" name="apiKey" value="{$_c['apiKey']}" placeholder="Enter API Key">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">App Name</label>
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="appName" name="appName" value="{$_c['appName']}" placeholder="Enter App Name">
                        </div>
                    </div>
                    <div class="form-group">
